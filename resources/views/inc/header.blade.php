              ...
              <div class="header__contacts">
                  <div class="header__contacts-body">
                      ...
                      <div class="header__contacts-content">
                          ...
                          <a class="header__contacts-contact" href="tel:%2B0633433434">@lang('main.contacts.phone')</a>
                      </div>
                  </div>
                  <div class="header__contacts-body">
                      <a href="mailto:info@eltop.com" class="header__contacts-icon">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                              <path d="M10.3674 8.66409L9.02736 10.0087C8.48395 10.554 7.52783 10.5657 6.97267 10.0087L5.63258 8.66409L0.81958 13.4927C0.998736 13.5756 1.19627 13.625 1.40627 13.625H14.5938C14.8038 13.625 15.0012 13.5756 15.1803 13.4927L10.3674 8.66409Z" fill="url(#paint0_linear_1_334)"/>
                              <path d="M14.5937 2.375H1.40621C1.19621 2.375 0.998674 2.42444 0.81958 2.50728L5.96261 7.66738C5.96295 7.66772 5.96336 7.66778 5.96371 7.66813C5.96405 7.66847 5.96411 7.66894 5.96411 7.66894L7.63639 9.34675C7.81402 9.52438 8.18595 9.52438 8.36358 9.34675L10.0355 7.66922C10.0355 7.66922 10.0359 7.66847 10.0363 7.66813C10.0363 7.66813 10.037 7.66772 10.0374 7.66738L15.1803 2.50725C15.0012 2.42438 14.8037 2.375 14.5937 2.375Z" fill="url(#paint1_linear_1_334)"/>
                              <path d="M0.149562 3.16288C0.056875 3.35031 0 3.55838 0 3.78125V12.2188C0 12.4416 0.0568125 12.6497 0.149531 12.8371L4.97087 8.00016L0.149562 3.16288Z" fill="url(#paint2_linear_1_334)"/>
                              <path d="M15.8505 3.16281L11.0292 8.00016L15.8505 12.8372C15.9431 12.6497 16 12.4417 16 12.2187V3.78125C16 3.55831 15.9431 3.35025 15.8505 3.16281Z" fill="url(#paint3_linear_1_334)"/>
                              <defs>
                              <linearGradient id="paint0_linear_1_334" x1="0.813141" y1="11.1443" x2="15.1832" y2="10.9177" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#036A35"/>
                              <stop offset="1" stop-color="#94CC23"/>
                              </linearGradient>
                              <linearGradient id="paint1_linear_1_334" x1="0.813141" y1="5.92708" x2="15.185" y2="5.76886" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#036A35"/>
                              <stop offset="1" stop-color="#94CC23"/>
                              </linearGradient>
                              <linearGradient id="paint2_linear_1_334" x1="-0.00222891" y1="7.99945" x2="4.97306" y2="7.98553" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#036A35"/>
                              <stop offset="1" stop-color="#94CC23"/>
                              </linearGradient>
                              <linearGradient id="paint3_linear_1_334" x1="11.0269" y1="7.99945" x2="16.0022" y2="7.98552" gradientUnits="userSpaceOnUse">
                              <stop stop-color="#036A35"/>
                              <stop offset="1" stop-color="#94CC23"/>
                              </linearGradient>
                              </defs>
         ...
         <div class="header__body">
            <nav class="header__menu">
               <ul class="header__menu-list">
                  <li class="header__menu-list-item"><a href="#" class="header__menu-list-link">@lang('header.about')</a></li>
                  <li class="header__menu-list-item"><a href="#" class="header__menu-list-link">@lang('header.advantages')</a></li>
                  <li class="header__menu-list-item"><a href="#" class="header__menu-list-link">@lang('header.catalog')</a></li>
                  <li class="header__menu-list-item"><a href="#" class="header__menu-list-link">@lang('header.contants')</a></li>
               </ul>
            </nav>
                  ...
                  <div class="header__language language-btn">
                     <div class="language-btn__select">
                        <div class="language-btn__link @lang('lang.current')">
                           <a href="{{ route('locale', __('lang.current')) }}" class="language-btn__text">@lang('lang.current')</a>
                        </div>
                     </div>
                     <div class="language-btn__select">
