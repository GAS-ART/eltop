@extends('layout')
@section('title', __('titles.s1155.title'))
@section('description', __('titles.s1155.description'))
@section('ogTitle' ,__('titles.s1155.ogTitle'))
@section('ogDescription', __('titles.s1155.ogDescription'))
@section('ogUrl', __('titles.s1155.ogUrl'))
@section('page', 'home')
  ...
  <div class="product__container">
    <div class="product__body">
      <div class="product__img">
        @if(App::isLocale('ua'))
        <img src="{{ asset('img/nibe/pumps/ua/тепловий-насос-Nibe-S1255.webp') }}" alt="Тепловий насос Nibe S1255">
        @elseif(App::isLocale('ru'))
        <img src="{{ asset('img/nibe/pumps/ru/тепловой-насос-Nibe-S1255.webp') }}" alt="Тепловой насос Nibe S1255">
        @endif
      </div>
  ...
  <div class="modifications__container">
    ...
    <div class="modifications__body">
      ...
      <div class="modifications__item">
        ...
        <button data-product="@lang('product.nibe.s1255.modifications.12')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.s1255.modifications.16')</h3>
        <button data-product="@lang('product.nibe.s1255.modifications.16')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text link-on-popup">@lang('product.nibe.s1255.modifications.r6')</h3>
        <button data-product="@lang('product.nibe.s1255.modifications.r6')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text link-on-popup">@lang('product.nibe.s1255.modifications.r12')</h3>
        <button data-product="@lang('product.nibe.s1255.modifications.r12')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text link-on-popup">@lang('product.nibe.s1255.modifications.r16')</h3>
        <button data-product="@lang('product.nibe.s1255.modifications.r16')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text link-on-popup">@lang('product.nibe.s1255.modifications.r6_230')</h3>
        <button data-product="@lang('product.nibe.s1255.modifications.r6_230')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text link-on-popup">@lang('product.nibe.s1255.modifications.r12_230')</h3>
        <button data-product="@lang('product.nibe.s1255.modifications.r12_230')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
    </div>
  </div>
