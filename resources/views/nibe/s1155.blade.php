...
<section class="breadcrumbs">
  <div class="breadcrumbs__container">
    <div class="catalog-page__breadcrumbs">
      ...
      <span>@lang('breadcrumbs.nibe.s1155')</span>
    </div>
  </div>
</section>
  ...
  <div class="product__container">
    <div class="product__body">
      <div class="product__img">
        @if(App::isLocale('ua'))
        <img src="{{ asset('img/nibe/pumps/ua/тепловий-насос-Nibe-S1155.webp') }}" alt="Тепловий насос Nibe S1155">
        @elseif(App::isLocale('ru'))
        <img src="{{ asset('img/nibe/pumps/ru/тепловой-насос-Nibe-S1155.webp') }}" alt="Тепловой насос Nibe S1155">
        @endif
      </div>
  ...
  <div class="modifications__container">
    ...
    <div class="modifications__body">
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.s1155.6')</h3>
        <button data-product="@lang('product.nibe.s1155.6')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.s1155.12')</h3>
        <button data-product="@lang('product.nibe.s1155.12')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.s1155.16')</h3>
        <button data-product="@lang('product.nibe.s1155.16')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.s1155.6_230')</h3>
        <button data-product="@lang('product.nibe.s1155.6_230')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.s1155.12_230')</h3>
        <button data-product="@lang('product.nibe.s1155.12_230')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.s1155.25')</h3>
        <button data-product="@lang('product.nibe.s1155.25')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
    </div>
  </div>
