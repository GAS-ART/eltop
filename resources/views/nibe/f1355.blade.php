@extends('layout')
@section('title', __('titles.f1355.title'))
@section('description', __('titles.f1355.description'))
@section('ogTitle' ,__('titles.f1355.ogTitle'))
@section('ogDescription', __('titles.f1355.ogDescription'))
@section('ogUrl', __('titles.f1355.ogUrl'))
@section('page', 'home')
...
<section class="breadcrumbs">
  <div class="breadcrumbs__container">
    <div class="catalog-page__breadcrumbs">
      ...
      <span>@lang('breadcrumbs.nibe.f1355')</span>
    </div>
  </div>
</section>
  ...
  <div class="product__container">
    <div class="product__body">
      <div class="product__img">
        @if(App::isLocale('ua'))
        <img src="{{ asset('img/nibe/pumps/ua/тепловий-насос-Nibe-F1355.webp') }}" alt="Тепловий насос Nibe F1355">
        @elseif(App::isLocale('ru'))
        <img src="{{ asset('img/nibe/pumps/ru/тепловой-насос-Nibe-F1355.webp') }}" alt="Тепловой насос Nibe F1355">
        @endif
      </div>
      <div class="product__content">
        <h1 class="product__content-title">@lang('product.nibe.f1355.title')</h1>
        <p class="product__content-text">@lang('product.nibe.f1355.text')</p>
        <div class="product__content-actions">
          <button data-product="@lang('product.nibe.f1355.lead')" data-popup-id="main"
  ...
  <div class="modifications__container">
    ...
    <div class="modifications__body">
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.f1355.28')</h3>
        <button data-product="@lang('product.nibe.f1355.28')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
      <div class="modifications__item">
        <h3 class="modifications__text">@lang('product.nibe.f1355.43')</h3>
        <button data-product="@lang('product.nibe.f1355.43')" data-popup-id="main"
          class="modifications__link link-on-popup">@lang('product.nibe.s1255.modifications.link')</button>
      </div>
    </div>
  </div>
